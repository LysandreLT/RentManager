                    ...
                    <div class="box">
                        ...
                        <form class="form-horizontal" method="post">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label for="nbDePlaces" class="col-sm-2 control-label">Nombre de places</label>

                                    <div class="col-sm-10">
                                        <input type="nbDePlaces" class="form-control" id="nbDePlaces" name="nbDePlaces" placeholder="Nombre de places">
                                    </div>
                                </div>
                            </div>
                            <!-- /.box-body -->
